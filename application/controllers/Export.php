...
class Export extends CI_Controller {
    ...
    public function createXLS() {
        ...
        foreach ($empInfo as $element) {
            $objPHPExcel->getActiveSheet()->SetCellValue('A' . $rowCount, $element['Data_chegada']);
            $objPHPExcel->getActiveSheet()->SetCellValue('B' . $rowCount, $element['Usuario']);
            $objPHPExcel->getActiveSheet()->SetCellValue('C' . $rowCount, $element['status']);
