...
<input type="text" class="form-control" name="email" id="email" value="<?php echo $perfili->email?>" disabled>
</div>
<div>&nbsp;</div>
<div class="col-md-6">
...
<input type="text" class="form-control" name="sobrenome" id="sobrenome"value="<?php echo $perfili->sobrenome?>">
</div>
<div>&nbsp;</div>
<div class="col-md-6">
...
<select class="form-control" disabled >
    <option value="1"><?php echo $perfili->status ?></option>
...
?>
        ...
        <tr>
          	<th height="25" align="left" valign="top" class=""><div align="left" style="width: 47px;
    overflow: hidden; text-overflow: clip;white-space: nowrap;"><span class="">
					<b><a href="#"><?php echo $linha->protocolo; ?></a></b></span></div></th>
    ...
    $datad = date('d/m/Y', strtotime($data));
        ...
        <tr>
          	<th height="25" align="left" valign="top" class=""><div align="left" style="width: 47px;
    overflow: hidden; text-overflow: clip;white-space: nowrap;"><span class="">
					<b><a href="#"><?php echo $linh->protocolo?></a></th>
          <td><?php echo  $datach ?></td>
          <td><?php echo $datad ?></td>
