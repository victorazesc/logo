...
<table class="table table-condensed">
      ...
      <tbody>
        ...
        <tr>
          <th scope="row"><a href="#" data-toggle="modal" data-target="#myModal<?php echo $users->user_id?>" ><?php echo $users->name?></a></th>
          <td><?php echo $users->email?></td>
          <td><?php if($users->status == '1'){ echo 'Administrador';}
elseif($users->status == '2'){ echo 'Controladoria';}
elseif($users->status == '3'){ echo 'Logistica';}?></td>
        ...
        <!-- Modal -->
<div class="modal fade" id="myModal<?php echo $users->user_id?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
         <h4 class="modal-title" id="myModalLabel">Usuario <?php echo $users->email ?> <span class="pull-right">
    <form method="post">
